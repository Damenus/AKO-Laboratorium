...
ptl3hex:
	...
	mov ecx, 1 ; licznik petli wstawiajacej spacje
ptl:
	mov dl, [edi + ecx]
	cmp dl, '0'
	jne ptl_end
	...
	inc ecx
	cmp ecx, 8 ; jezeli doszlismy do ostatniego zera liczby
	; znaczy to, ze podane bylo zero i nie nalezy go zastepowac
	jnge ptl
ptl_end:
