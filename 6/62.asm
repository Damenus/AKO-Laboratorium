...
obsluga_zegara PROC
	; przechowanie uzywanych rejestrów
	push ax
	push bx
	push es
	
	inc cs:int_counter
	cmp cs:int_counter, 19
	jne koniec
	mov cs:int_counter, 0
	...
	; sprawdzenie czy adres biezacy osiagna³ koniec pamieci ekranu
	cmp bx,4000
	jb wysw_dalej ; skok gdy nie koniec ekranu
	mov bx, 0 ; wyzerowanie adresu biezacego, gdy ca³y ekran zapisany
	
wysw_dalej:
	mov cs:licznik,bx 	;zapisanie adresu biezacego do zmiennej 'licznik'
...
koniec:
	...
	wektor8 dd ?
	int_counter db 18 ; ilosc otrzymanych przerwan
obsluga_zegara ENDP
